...
// -----------------------------------------------------------------------------
// Gemma4 Inference Main Entry
// -----------------------------------------------------------------------------

int main() {
  const std::string title = "Gemma4 Inference Powered by Buddy Compiler";
  std::cout << "\033[33;1m" << title << "\033[0m" << std::endl;

  std::string exampleDir = GEMMA4_EXAMPLE_PATH;
  std::string buildDir = GEMMA4_EXAMPLE_BUILD_PATH;
  const std::string vocabDir = buildDir + "vocab.txt";
  const std::string paramsDir = buildDir + "arg0.data";
