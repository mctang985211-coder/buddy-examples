...
# ===---------------------------------------------------------------------------
#
# Canonical (official-implementation) reference for the BertSmall e2e workload.
#
# Runs `prajjwal1/bert-small` (4 layers, hidden 512, intermediate 2048, 8 heads,
...
# not just an argmax:
#
#   reference/bertsmall_mlm_logits_f32.bin  raw little-endian float32, C order
...
#
#   python3 pytorch-bertsmall-mlm.py --write-reference       # generate
#   python3 pytorch-bertsmall-mlm.py --check <candidate.bin> # verify
#
# ===---------------------------------------------------------------------------
...
def fixed_inputs(tokenizer) -> dict[str, torch.Tensor]:
    ...
    `import-bertsmall.py` expands this dict as kwargs, so BERT-family
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="BertSmall masked-LM canonical reference generator / checker"
    )
    ...
    reference_path = args.reference_dir / "bertsmall_mlm_logits_f32.bin"
